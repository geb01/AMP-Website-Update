...
<head>
    ...
    <title>Ateneo Musician's Pool - Contact Us</title>
    ...
    <body>
        ...
        <div class="box">
            <input type="email" placeholder="juanadelacruz@gmail.com" id="email" name="email" required><br><br>
        </div>
        ...
        <div class="box">
            <textarea id="message" name="message" placeholder="Please input your concerns/requests/messages here" required></textarea><br><br>
        </div>
